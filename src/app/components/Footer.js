    ...
    <div className="pt-6 pb-12">
      <div className="container px-6 py-12 mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            ...
            <p className="text-2xl py-2 text-black font-medium text-orange-400">PocketDrive</p>
            <p className="max-w-lg text-lg font-medium tracking-tight text-gray-800 dark:text-white">Subscribe to our newsletter.</p>
                ...
                <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                    ...
                    <button className="w-full px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 transform md:w-auto md:mx-4 focus:outline-none bg-black rounded-lg hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                        Subscribe
                    </button>
                </div>
            </div>
            ...
            <div>
                <p className="font-semibold text-gray-800 dark:text-white">Engage</p>
